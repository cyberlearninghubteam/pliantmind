        ...
        >
          {services.map((service) => (
            <motion.div
              ...
              className="group rounded-2xl border border-border bg-surface p-8 hover:border-accent/30 hover:bg-surface-light transition-all duration-300"
            >
              <div className="inline-flex items-center justify-center h-12 w-12 rounded-xl bg-accent/10 text-accent mb-5 group-hover:bg-accent/20 transition-colors">
                {service.icon}
              </div>
